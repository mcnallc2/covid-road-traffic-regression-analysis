...
covid_traffic.k_folds_cross_validation(
    2, X_train, y_train, model_type='linreg', Q=1, K='N/A', C='N/A')

## POLY FEATURES CROSS VALIDATION
covid_traffic.poly_feature_cross_validation(
    3, X_train, y_train, model_type='linreg', folds=50, K='N/A', C='N/A')

## PLOT PREDICTIONS
covid_traffic.plot_predictions(5, X_train, X_test, y_train, y_test, model_type='linreg', folds=50, Q=1, K='N/A', C='N/A')