...
covid_traffic.k_folds_cross_validation(
    2, X_train, y_train, model_type='lasso', Q=1, K='N/A', C=1)

## POLY FEATURES CROSS VALIDATION
covid_traffic.poly_feature_cross_validation(
    3, X_train, y_train, model_type='lasso', folds=25, K='N/A', C=1)

## C PENALTY CROSS VALIDATION
covid_traffic.c_penalty_cross_validation(
    4, X_train, y_train, model_type='lasso', folds=25, Q=4, K='N/A')

## PLOT PREDICTIONS
covid_traffic.plot_predictions(5, X_train, X_test, y_train, y_test, model_type='lasso', folds=25, Q=1, K='N/A', C=1)